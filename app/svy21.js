//Based from https://github.com/cgcai/SVY21
...
var SVY21 = (function(){
    ...
    this.computeSVY21 = function(latlon){
        var lat = latlon.lat;
        var lon = latlon.lon;
    ...
    this.computeLatLon = function(NE){
        var N = NE.N;
        var E = NE.E;
    ...
    //From https://github.com/SomeoneWeird/latlong
    this.move = function(latlon, mNorth, nEast) {
        var _lat  = mNorth / R;
        var _lon  = nEast / (R * Math.cos(Math.PI * latlon.lat / 180));
        return {lat: latlon.lat + _lat * 180 / Math.PI, lon: latlon.lon + _lon * 180 / Math.PI};
    }
    
    this.moveNorth = function(latlon, m){
        return this.move(latlon, m, 0);
    }
    
    this.moveSouth = function(latlon, m){
        return this.move(latlon, -m, 0);
    }
    
    this.moveEast = function(latlon, m){
        return this.move(latlon, 0, m);
    }
    
    this.moveWest = function(latlon, m){
        return this.move(latlon, 0, -m);
    }
    
});

module.exports = new SVY21();